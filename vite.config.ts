    ...
    plugins: [
      VitePWA({
        ...
        manifest: {
          ...
          scope: "/",
          icons: [
            { src: "/pwa-192.png?v=20260614-splash", sizes: "192x192", type: "image/png" },
            { src: "/pwa-512.png?v=20260614-splash", sizes: "512x512", type: "image/png" },
            {
              src: "/pwa-512.png?v=20260614-splash",
              sizes: "512x512",
              type: "image/png",
